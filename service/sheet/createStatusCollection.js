  ...
  try {
    ...
    const statusData = {
      ...
      wifiOwnerName: branch?.wifiOwnerName
        ? branch?.wifiOwnerName
        : "no wifi owner name",
      houseRentAccount: branch?.houseRentAccount
        ? branch?.houseRentAccount
        : "no house rent account",
      houseRentOwnerName: branch?.houseRentOwnerName
        ? branch?.houseRentOwnerName
        : "no house owner name",
      ethioTelAccount: branch?.ethioTelAccount
        ? branch?.ethioTelAccount
        : "no ethio Tel Account",
      ethioTelOwnerName: branch?.ethioTelOwnerName
        ? branch?.ethioTelOwnerName
        : "no ethio tele phone owner name",
