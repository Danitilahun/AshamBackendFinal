...
const payWaterDeliveryGuy = async (db, data, batch, WaterCount) => {
  try {
    ...
    const newSalaryExpense = await updateTable(
      ...
      "total",
      {
        ...
        total: parseInt(WaterCount) * DeliveryGuyGain.water_collect_price,
      },
      batch
    );
...
module.exports = payWaterDeliveryGuy;
