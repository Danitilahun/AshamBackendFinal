...
//       await handleDeliveryOperations(branchId, sheetId, date);

//       // Step 6: Handle sheet operations
//       await handleSheetOperations(sheetId, date, branchId);

//       // Step 7: Add the day to the daily 15-day summary sheet
//       await addDayToDaily15DaySummerySheet(sheetId, branchId, date);
//     }
